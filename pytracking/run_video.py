...
def main():
    ...
    parser.add_argument('--tracker_name', default=None, type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default=None, type=str, help='Name of parameter file.')
    parser.add_argument('--videofile', default=r"../beauty_1656059439229.mp4", type=str, help='path to a video file.')
